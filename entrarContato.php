					...
					<div class="card-body">
						<form id="formID" novalidate="novalidate" onsubmit="return validarDados()">
							<div class="form-group">
								...
								<input type="text" name="Nome Completo" class="form-control" id="nomeCompleto" pattern="(?=^.{2,60}$)^[A-Z][a-z]+(?:[ ](?:das?|dos?|de|e|[A-Z][a-z]+))*$" placeholder="Digite seu nome completo..." required />
							</div>
							<div class="form-group">
								<label for="endereco">Endereço</label>
								<input type="text"name="Endereço" class="form-control" id="endereco" placeholder="Digite seu endereço..." required />
							</div>
							<div class="form-group">
								<label for="email">Email</label>
								<input type="email" name="Email" class="form-control" id="email" pattern="[a-z][a-z0-9]*\.?[a-z]+@([a-z]+\.)+[a-z]+" title="exemplo@hotmail.com" placeholder="Digite seu email..." required />
							</div>
							<div class="form-group">
								<label for="mensagem">Mensagem</label>
								<textarea name="Mensagem" class="form-control" id="mensagem" rows="3" placeholder="Digite sua mensagem..." required ></textarea>
							</div>
